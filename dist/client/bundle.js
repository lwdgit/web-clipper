;/*!/client/clean-rules/cnblogs_code.js*/
...
;/*!/client/clean-rules/crayon-syntax.js*/
...
;/*!/client/clean-rules/dp-highlighter.js*/

_cmd_define('/client/clean-rules/dp-highlighter.js', function(_cmd_require, exports, module) {
module.exports = function(code) {
    return '';
};
});

;/*!/client/clean-rules/prettyprint.js*/
...
;/*!/client/clean-rules/syntaxhighlighter.js*/

_cmd_define('/client/clean-rules/syntaxhighlighter.js', function(_cmd_require, exports, module) {
...
;/*!/client/lib/readability.js*/

_cmd_define('/client/lib/readability.js', function(_cmd_require, exports, module) {
...
var userClean = _cmd_require('/client/lib/clean.js') || function(e) {dbg('no user clean rules!')};
